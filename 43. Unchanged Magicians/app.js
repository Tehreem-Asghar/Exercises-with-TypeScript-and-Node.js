...
//show_magicians(magicians);
//new Exercise;
let magicians_names = ['Harry Houdini', 'David Blaine', 'David Copperfield', 'Ricky Jay'];
function make_great2(magicians) {
    let great_magicians = magicians.map(magicians => `The Great ${magicians}`);
    return great_magicians;
}
let great_magicians2 = make_great2(magicians_names);
show_magicians(magicians);
